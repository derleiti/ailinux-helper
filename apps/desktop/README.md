...
> Current Helper release: **2.90.28**. The desktop component is now branded **AILinux Helper**. `ailinux-helper://` is the primary deep-link scheme; `ailinux-workspace://` remains a compatibility alias.
